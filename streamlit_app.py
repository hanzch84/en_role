...
key_phrases = st.text_input("주요 표현 입력",placeholder="What's wrong?, Go see a doctor, Get some rest 등의 연습하고 싶은 표현을 쉼표나 엔터로 구분해서 입력하세요.")
key_words = st.text_area("주요 단어 입력",placeholder="cold, headache, medicine 등의 연습하고 싶은 단어를 쉼표나 엔터로 구분해서 입력하세요.")
